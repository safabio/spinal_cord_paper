...
feat_list_plot <- function(x) {
 plot <- modplots::mFeaturePlot(my.se, my.features = x,
                       gnames = gnames, size = 0.2, return = FALSE)
 return(plot)
}

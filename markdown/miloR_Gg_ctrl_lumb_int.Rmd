...
```{r DA-beeswarm}
da.results$seurat_clusters <- factor(da.results$seurat_clusters, levels = rev(c("Mixed", as.character(1:34))))
...
pdf("~/spinal_cord_paper/figures/Fig_4_BL10int_milo_volplot.pdf", height = 10, width = 5)
plotDAbeeswarm(da.results, group.by = "seurat_clusters", alpha=1.0) 
dev.off()

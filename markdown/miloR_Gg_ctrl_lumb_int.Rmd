...
my.se <- readRDS("~/spinal_cord_paper/data/Gg_ctrl_lumb_int_seurat_070223.rds")

my.se$cond <- substr(my.se$orig.ident, 7, 10)
# represents the sequencing batch as well
my.se$batch <- substr(my.se$orig.ident, 7, 12) 
...
# pdf export figures
pdf(paste0("~/spinal_cord_paper/figures/",my.se@project.name ,"_milo_",format(Sys.Date(), "%d%m%y"),".pdf"), width = 5, height = 4)

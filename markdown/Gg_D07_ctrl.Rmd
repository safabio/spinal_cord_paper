---
title: "Seurat workflow of Gg_D07_ctrl"
author: "Fabio Sacher"
date: "06.02.2023"
output:
  html_document:
...
my.samples[[1]] <- readRDS("~/spinal_cord_paper/data/D07_ctrl_filtered_060223.rds")

#The sample name, will  be used in plots and files
my.samplename <- "Gg_D07_ctrl"
```

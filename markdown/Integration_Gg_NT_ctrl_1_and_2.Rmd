---
title: "Integration of Gg ctrl 1 and 2"
author: "Fabio Sacher"
date: "06.02.2023"
output:
  html_document:
...
my.samples[[1]] <- readRDS("~/spinal_cord_paper/data/Gg_ctrl_1_seurat_060223.rds")
my.samples[[2]] <- readRDS("~/spinal_cord_paper/data/Gg_ctrl_2_seurat_060223.rds")

names(my.samples) <- c("Gg_ctrl_1", "Gg_ctrl_2")
...
```{r, save object}
saveRDS(int.nt.sct, file = paste0("~/spinal_cord_paper/data/Gg_ctrl_integrated_",format(Sys.Date(), "%d%m%y"),".rds"))
```

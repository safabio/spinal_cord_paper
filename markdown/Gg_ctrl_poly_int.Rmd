---
title: "Integration and Seurat workflow of Gg ctrl_1, ctrl_2, poly_1, and poly_2 (brachial vs polydactyl)"
author: "Fabio Sacher"
output:
  html_document:
    toc: TRUE
...
my.samples[[1]] <- readRDS("~/spinal_cord_paper/data/Gg_ctrl_1_seurat_070223.rds")
my.samples[[2]] <- readRDS("~/spinal_cord_paper/data/Gg_ctrl_2_seurat_070223.rds")
my.samples[[3]] <- readRDS("~/spinal_cord_paper/data/Gg_poly_1_seurat_070223.rds")
my.samples[[4]] <- readRDS("~/spinal_cord_paper/data/Gg_poly_2_seurat_070223.rds")

names(my.samples) <- c("Gg_ctrl_1", "Gg_ctrl_1", "Gg_poly_1", "Gg_poly_2")
...
my.int@project.name <- "Gg_ctrl_poly_int"
...
```{r cell-cycle-scoring, message=FALSE, warning=FALSE, echo = T, results = 'hide'}

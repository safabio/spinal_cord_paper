...
```{r data-sets}
se_path <- c("Gg_ctrl_int_seurat_070223",
...
```{r export-ctrl-lumb}
pdf("~/spinal_cord_paper/figures/heatmap_pearson_ctrl_lumb_int.pdf", width = 12, height = 11)
...
```{r export-ctrl-poly}
pdf("~/spinal_cord_paper/figures/heatmap_pearson_ctrl_poly_int.pdf", width = 12, height = 11)
grid.arrange(corr_heatmap[[4]])
dev.off()
```

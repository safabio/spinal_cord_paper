---
title: "Integration of Gg poly 1 and 2"
author: "Fabio Sacher"
date: "06.02.2023"
output:
  html_document:
...
my.samples[[1]] <- readRDS("~/spinal_cord_paper/data/Gg_poly_1_seurat_070323.rds")
my.samples[[2]] <- readRDS("~/spinal_cord_paper/data/Gg_poly_2_seurat_070323.rds")

names(my.samples) <- c("Gg_poly_1", "Gg_poly_2")
...
```{r, save object}
saveRDS(int.nt.sct, file = paste0("~/spinal_cord_paper/data/Gg_poly_integrated_",format(Sys.Date(), "%d%m%y"),".rds"))
```

---
title: "Seurat workflow of Gg_NT_ctrl_1 (with SoupX and ddqc)"
author: "Fabio Sacher"
date: "20.01.2023"
output:
  html_document:
...
my.samples[[1]] <- readRDS("~/test/NT_test_soupx_ddqcR/control1_ddqc_250123.rds")

#The sample name, will  be used in plots and files
my.samplename <- "Gg_NT_ctrl_1"
```

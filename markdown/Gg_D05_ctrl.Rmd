---
title: "Seurat workflow of Gg_NT_D05_ctrl (with SoupX and ddqc)"
author: "Fabio Sacher"
date: "20.01.2023"
output:
  html_document:
...
my.samples[[1]] <- readRDS("~/test/NT_test_soupx_ddqcR/D05_ctrl_ddqc_250123.rds")

#The sample name, will  be used in plots and files
my.samplename <- "Gg_NT_D05_ctrl"
```

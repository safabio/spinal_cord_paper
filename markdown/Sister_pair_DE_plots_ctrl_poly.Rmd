---
title: "Sister pair DE analysis, doplots and volcanoplots ctrl -vs- poly"
author: "Fabio Sacher"
date: "18.09.2023"
data:
output:
...
p5 <- modplots::mDotPlot2(my.se,
                    group.by = "annot_sample",  
                    assay = "RNA",
                      # RELN (to ensure proper scaling) and
                      # ND3 (filter out previously due to delta_pct = 0.009)
                    features = c("ENSGALG00000008193", "ENSGALG00000030436"),
                    gnames = modplots::gnames,
          cols = c("lightgrey", "black")) +
    theme(axis.text.x = element_text(angle = 90, hjust=1, vjust=0.5)) +
    coord_flip() +

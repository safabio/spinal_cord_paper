---
title: "Integration of all Day10 samples"
author: "Fabio Sacher"
date: "05.09.2025"
output:
  html_document:
...
names(my.samples) <- c("Gg_ctrl_1","Gg_ctrl_2","Gg_lumb_1","Gg_lumb_2","Gg_poly_1","Gg_poly_2")
...
```{r, save object}
saveRDS(int.nt.sct, file = paste0("~/spinal_cord_paper/data/Gg_day10_integrated_",format(Sys.Date(), "%d%m%y"),".rds"))
```

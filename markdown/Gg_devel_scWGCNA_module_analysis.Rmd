...
modplots[[1]][[6]] + modplots[[1]][[7]] |
  modplots[[2]][[6]] + modplots[[2]][[7]] |
  modplots[[3]][[6]] + modplots[[3]][[7]]
...
my.sec$orig.ident <- factor(
  my.sec$orig.ident,
  levels = unique(my.sec$orig.ident)
  )
...
vln_ind
pdf("~/spinal_cord_paper/figures/Fig_1_AE_MNs.pdf", height = 5, width = 20)
vln_ind
```

...
```{r AE-over-time, fig.height=4, fig.width=12}
# module annotations
...
pdf("~/spinal_cord_paper/figures/Fig_2_mean_mod_AE.pdf", height = 2.7, width = 12)
mean_mod
dev.off()
```
...
```{r second_to_last, fig.width=20, fig.height=5}

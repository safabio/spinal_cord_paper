...
htmp <- heatmap.4(as.matrix(my.wgmat[[1]]),
          col = colorRampPalette(c("#4d2d87","#7c55a3", "white", "#ed9921", "#895d25"))(n = 1000),
          trace="none",
          scale = "row",
          margins = c(10,10),
...
pdf("~/spinal_cord_paper/figures/Fig_2_selected_mod_tsne.pdf", height = 21, width = 12)
modplots[[1]][[22]] + modplots[[1]][[2]] + modplots[[1]][[6]] + modplots[[1]][[12]] + modplots[[1]][[13]] + modplots[[1]][[18]] + modplots[[1]][[21]] |
  modplots[[2]][[22]] + modplots[[2]][[2]] + modplots[[2]][[6]] + modplots[[2]][[12]] + modplots[[2]][[13]] + modplots[[2]][[18]] + modplots[[2]][[21]] |
  modplots[[3]][[22]] + modplots[[3]][[2]] + modplots[[3]][[6]] + modplots[[3]][[12]] + modplots[[3]][[13]] + modplots[[3]][[18]] + modplots[[3]][[21]]
...
vln_ind <- VlnPlot(my.sec,
                   features = c("AEdarkred", "AEpink", "AEgreen", "AEdarkgreen", "AEroyalblue", "AEcyan", "AElightgreen"),
                   group.by = "sample_celltype",
                   stack = TRUE,
                   flip = TRUE,
                   cols = c("darkred", "pink", "green", "darkgreen", "royalblue", "cyan", "lightgreen"),pt.size = 1
                  ) +
    NoLegend()
...
pdf("~/spinal_cord_paper/figures/Fig_2_AE_by_stage.pdf", height = 20, width = 20)
v1

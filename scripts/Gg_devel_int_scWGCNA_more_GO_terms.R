...
seurat_files <- c("~/spinal_cord_paper/data/Gg_devel_int_seurat_250723.rds",
...
scWGCNA_files <- c("~/spinal_cord_paper/output/Gg_devel_int_scWGCNA_250723.rds",
...
for (j in seq(seurat_files)) {
  # load seurat object
  my.se <- readRDS(seurat_files[[j]])
  my.scWGCNA <- readRDS(scWGCNA_files[[j]]) 
